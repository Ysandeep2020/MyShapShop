    ...
    <head>
      ...
      <style type="text/css">
        .notification-count {
          ...
          border-radius: 50%;
          /* Rounded shape for the background */
          padding: 3px 8px;
          /* Adjust the padding for the size of the count */
          font-size: 9px;
          /* Adjust the font size of the count */
        }
      </style>
      ...
      <div class="container-scroller">
        ...
        <div class="container-fluid page-body-wrapper">
          ...
          <div class="main-panel">
            <div class="content-wrapper" id="contentcontent">     
